...
app.config['MAIL_USERNAME'] = 'devendra.rai04@gmail.com'
app.config['MAIL_PASSWORD'] = 'Devendra@Rai04'
app.config['MAIL_USE_TLS'] = True
app.config['MAIL_USE_SSL'] = False
app.config['MAIL_DEFAULT_SENDER'] = ('FIGHT COVID', 'devendra.rai04@gmail.com')
